...
The companion `thread-negative` phase safely exercises four non-creating kernel
thread wrappers with invalid IDs and records their signed `-1` results and
restored stacks; live thread scheduling remains unproven.
