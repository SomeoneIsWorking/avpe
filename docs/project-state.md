...
`GetGsHParam`, `GetGsVParam`, `MachineType`, and `GetMemorySize` results (`1`,
`0x01FF5000`, `0`, `0x00000080`, `0x00008000`, and `0x02000000`) plus the
grounded void `PSMode` call. Its result remains explicitly unobserved, so stale
register contents are not claimed as an ABI value.
